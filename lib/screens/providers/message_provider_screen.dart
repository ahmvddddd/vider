...
class MessageProviderScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<MessageProviderScreen> createState() => _MessageState();
}

class _MessageState extends ConsumerState<MessageProviderScreen> {
